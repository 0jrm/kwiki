...
Plans:
- [ ] 03-01: PR #2 — Supersession + version chain; contradicting claims get `supersedes`/`superseded_by` links instead of overwrites
- [ ] 03-02: PR #3 — Retention decay in wiki-lint; Ebbinghaus model, flag below-threshold pages
- [ ] 03-03: PR #4 — Consolidation tiers; automatic working→episodic→semantic→procedural promotion logic
